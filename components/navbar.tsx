...
export default function Navbar() {
    return (
        <nav className="fixed  top-0 left-[300px] flex justify-between w-[320px] items-center right-0  md:h-[92px] md:w-[1623px] shadow-[0_4px_10px_rgba(182,182,182,0.1)] z-50 bg-white">
            <div className="md:ml-[103px] font-bold font-ubranist md:text-3xl  lg:text-3xl ">
                ← Stories
            </div>
